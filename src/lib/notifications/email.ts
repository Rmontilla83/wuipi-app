        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#03318C,#060633);padding:32px 40px;text-align:center;">
              <img src="https://wuipi-app.vercel.app/img/wuipi-logo.png" alt="WUIPI" width="220" height="auto" style="display:block;margin:0 auto 8px;" />
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        <tr><td style="background:linear-gradient(135deg,#03318C,#060633);padding:32px 40px;text-align:center;">
          <img src="https://wuipi-app.vercel.app/img/wuipi-logo.png" alt="WUIPI" width="220" height="auto" style="display:block;margin:0 auto;" />
        </td></tr>
